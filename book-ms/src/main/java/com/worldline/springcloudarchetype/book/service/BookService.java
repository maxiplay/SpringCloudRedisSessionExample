package com.worldline.springcloudarchetype.book.service;
...
import com.worldline.springcloudarchetype.book.repository.BookRepository;
...
public class BookService {
	...
	public Page<Book> deleteBook(String bookId, String login, Pageable p)
			throws Exception {
